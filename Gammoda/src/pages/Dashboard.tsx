      ...
      <div className="bg-gray-50 min-h-screen py-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <h1 style={{ fontSize: "2rem", lineHeight: "1.2", fontFamily:"sanserif" }} className="text-gray-900">Welcome back, {candidateData?.name || user?.name}!</h1>
              <p style={{ fontSize: "1rem", lineHeight: "1.2", fontFamily:"sanserif" }} className="text-gray-600">Manage your profile and track your applications</p>
            </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle style={{ fontSize: "1.5rem", lineHeight: "1.2", fontFamily:"sanserif" }}>Personal Information</CardTitle>
                    <Button
                      variant="outline"
                      size="sm"
